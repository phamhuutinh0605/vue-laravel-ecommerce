<header x-data="{ mobileMenuOpen: false }" class="flex justify-between  items-center bg-slate-800 shadow-md text-white">
    <div>
        <a href="{{ route('home') }}" class="block py-navbar-item pl-5 text-2xl"> eShop </a>
    </div>
    <!-- Responsive Menu -->
    <div class=" fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-slate-900 md:hidden"
        ...
        <ul>
            <li>
                <a href="/src/cart.html"
                    ...
                    <!-- Cart Items Counter -->
                    <small x-show="$store.header.cartItems" x-transition x-text="$store.header.cartItems" x-cloak
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col items-center">
            <li class="flex justify-between p-4 items-center">
                <a href="/src/cart.html"
